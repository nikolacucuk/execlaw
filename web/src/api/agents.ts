...
export interface AgentRequest { name:string; role_prompt:string; model?:string|null; backend_purpose?:string; tools?:string[]; trust_policy?:Record<string, unknown>; trigger?:Record<string, unknown>; reply_mode?:"draft"|"automatic"; interval_secs?:number; token_budget?:number; max_runtime_secs?:number; concurrency_limit?:number; enabled?:boolean; }
