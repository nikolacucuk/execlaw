...
| [`whatsapp`](plugins/whatsapp/) | 0.2.2 | script | transport | WhatsApp Multi-Device via a supervised [wuzapi](https://github.com/asternic/wuzapi) (whatsmeow-backed) sidecar. QR pairing, retained direct-chat history, group ops, attachments, read receipts. |
